...
Command.prototype.handle = function(socket, msg) {
  ...
  opts.serverType = pomelo.app.getServerType();
  ...
  if(this.useProtobuf) {
    ...
    if(!msg.sys.protoVersion || msg.sys.protoVersion < protoVersion){
      opts.protos = {
          server : {},
          client : {},
          version : pomelo.app.components.__protobuf__.getVersion()
      }//pomelo.app.components.__protobuf__.getProtos();
    }
  }
  ...
  if(!!pomelo.app.components.__decodeIO__protobuf__) {
    ...
    if(!msg.sys.protoVersion || msg.sys.protoVersion < version) {
      opts.protos = {
          server : {},
          client : {},
          version : pomelo.app.components.__decodeIO__protobuf__.getVersion()
      }//pomelo.app.components.__decodeIO__protobuf__.getProtos();
    }
  }
